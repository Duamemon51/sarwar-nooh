...
<section className="relative overflow-hidden mt-[60px] sm:mt-[75px]" dir="rtl">
  ...
  <div className="absolute inset-0 hidden md:flex flex-col justify-center px-4 sm:px-8 md:px-12 items-end">
    <div className="w-[42%] max-w-[500px] flex flex-col items-end text-right">
      <div className="max-w-[340px] flex flex-col items-end gap-0 me-[68px]">
      ...
      <p className="text-white text-[clamp(1.35rem,2vw,1.75rem)] me-[68px] mt-4 mb-3">
        ھالا نوں، ضلعي مٽياري، سنڌ
      </p>

      <p className="text-white/80 text-[clamp(1rem,1.5vw,1.3rem)] leading-8 mb-6 max-w-[390px] me-[65px]">
      ...
      <button className="flex items-center gap-2 w-fit border border-[#e8c98a] rounded-full px-8 py-2.5 text-white text-sm hover:bg-white/10 transition me-[68px]">
        ...
        <span className="ms-2">وڈیو ڏسو</span>
  ...
  <div className="relative flex md:hidden min-h-[420px] overflow-hidden" dir="rtl">
    ...
    <div className="relative flex-1 px-4 py-6 flex flex-col justify-center items-start text-right">
      ...
      <button className="flex items-center gap-1.5 w-fit border border-[#e8c98a] rounded-full px-4 py-1.5 text-white text-xs hover:bg-white/10 transition">
        ...
        <span className="ms-1">وڈیو ڏسو</span>
